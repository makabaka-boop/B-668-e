  ...
  <div class="course-list">
    ...
    >
      ...
      <el-table-column label="操作" width="220" fixed="right">
        <template #default="{ row }">
          <el-button type="primary" size="small" round @click="viewLeaveList(row)">
            <el-icon><Document /></el-icon>
            查看请假
          </el-button>
          <el-button type="success" size="small" round @click="viewStats(row)">
...
import { Reading, Clock, Document, DataAnalysis } from '@element-plus/icons-vue'
